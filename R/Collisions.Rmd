...
## Assess
```{r echo=FALSE, message=FALSE, error=FALSE, df_glimpse}
# Function to print dataframe summaries.
df_glimpse <- function(this_df) {
  print(cat("Rows: ", dim(df)[1], "\nVariables: ", dim(df)[2],"\n\n"))
  print(str(df))
  print(summary(df))
}
```
...
print('INCDTTM ...')
df$INCDTTM[1]
(as.POSIXct(word(df$INCDTTM, 2), format='%H:%M'))
```

### Observations
* INCDATE includes only dates (not time), between 2003-10-06 and 2019-01-31
* 
