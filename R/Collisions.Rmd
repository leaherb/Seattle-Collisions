...
#### Can we deduce a value for NULL SDOT_COLCODE given any other information?
```{r}
...
#### Can we deduce a value for SEVERITYCODE where it is NULL?
```{r}
df[is.na(df$SEVERITYCODE),]
```
**Observation:** The one reocrd with SEVERITYCODE=NA could be marked '0' because INJURY, SERIOUSINJURIES and FATALITIES = 0
