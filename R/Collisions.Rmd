...
* Positive **DUI** and **DISTRACTED** were reported in approximately 11-13% of collisions. 

* Surprisingly, **SPEEDING** is infrequently noted in collision reports. 

**Note:** **DISTRACTED** and **SPEEDING** have only either a Y(es) or NULL value, suggesting that the lack of value (NULL) means these are not contributing factors. 
