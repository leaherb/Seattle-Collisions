...
# Use COLLISIONTYPE categories when possible, attempting to reverse-engineer ST_COLDESC's.
# TODO: repeat this programmatically, see if we can duplicate how COLLISIONTYPE may have been done.
...
df <- df %>%
    mutate(., ST_COLDESC_collisiontype = with(., case_when(
        (ST_COLCODE <= 5) ~ 'Pedestrian',  #'Vehicle Hits Pedestrian', 
