...
# Load data
#
# toggle data source: local file or live site
...
dfRaw = read.csv(datafile, na.strings=c("", " "), header=TRUE)
df <- data.frame(dfRaw)   # df (working dataset); dfRaw (as loaded)
```
